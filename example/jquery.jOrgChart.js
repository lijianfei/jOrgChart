        ...
        if ($childNodes.length > 0) {
            $nodeDiv.click(function () {
                ...
                if ($tr.hasClass('contracted')) {
                    $this.parents(".node-container").siblings().each(function (index) {
                        console.log($(this).find("div"));

                        $(this).find("div").each(function () {
                            $(this).css("cursor", "s-resize");
                            $(this).closest("tr").removeClass("expanded").addClass('contracted');
                            $(this).closest("tr").nextAll("tr").css('display', 'none');
                        });
                    });
                    $this.css('cursor', 'n-resize');
                    $tr.removeClass('contracted').addClass('expanded');
                    $tr.nextAll("tr").css('display', 'table-row');
                    console.log($this.parents(".node-container").siblings());
